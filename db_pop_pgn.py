...
def insert_game(event_id, white_player_id, black_player_id, result, date_time, white_elo, black_elo, white_rating_diff,
    ...
    if white_player_id is None or black_player_id is None:
        print(
            f"Skipping game due to missing player IDs: white_player_id={white_player_id}, black_player_id={black_player_id}")
        return None
    ...
    cur.execute("""
        ...
        RETURNING gameid;
    """, (event_id, white_player_id, black_player_id, result, date_time, white_elo, black_elo, white_rating_diff,
          black_rating_diff, eco, opening, time_control, termination))
...
def parse_pgn_and_insert(pgn_file_path):
    ...
    for game in games:
        ...
        event_data = {
            ...
            'event_type': 'Regular' if not tournament_id else 'Tournament',
            # Use 'Tournament' or 'Regular' based on the presence of tournament_id
        ...
        # Insert game
        game_id = insert_game(event_id, white_player_id, black_player_id, result, event_date, white_elo, black_elo,
